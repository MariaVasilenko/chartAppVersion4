...
//    private GridBagConstraints gbc;
    ...
    public ChartFrame(OpenFileFrame openFileFrame) throws HeadlessException {
        ...
        Dimension dim2 = new Dimension(800,500);
...
//        gbc.fill=GridBagConstraints.HORIZONTAL;
//        addComponent(panel,0,0, GridBagConstraints.RELATIVE, GridBagConstraints.RELATIVE);
...
//    }
    ...
    private JFreeChart createChart(XYDataset dataset, Settings settings) {
        ...
        String typeStr = settings.getType().getKey().equals("dynamic") ? "динамической" : "статической";
